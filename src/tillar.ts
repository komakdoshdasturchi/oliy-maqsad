...
const LUGAT_AR: Record<string, string> = {
  ...
  "Shaxsiy iqtiboslar": "اقتباسات شخصية",
  "Iqtibos o'chirilsinmi?": "هل يُحذف هذا الاقتباس؟",
  ...
  "O'zingizga eslatma yoki iqtibos...": "تذكير أو اقتباس لنفسك...",
  "O'zingiz uchun iqtibos yoki eslatma yozing — Bugun sahifasining tanlangan joyida ko'rinib turadi.": "اكتب اقتباسًا أو تذكيرًا لنفسك — يبقى ظاهرًا في المكان الذي تختاره من صفحة اليوم.",
  "Joylashuv: Tepada — progress ostida · O'rtada — vazifalardan oldin · Pastda — kun xulosasidan oldin.": "الموضع: في الأعلى — تحت التقدم · في الوسط — قبل المهام · في الأسفل — قبل ملخّص اليوم.",
