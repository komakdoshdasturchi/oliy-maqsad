...
const LUGAT_RU: Record<string, string> = {
  ...
  "Qachon boshlanadi?": "Когда начинается?",
  ...
  "Kundalik vazifa": "Ежедневная задача",
  ...
  "Papka nomi": "Название папки",
  "Turi": "Тип",
  "Turi:": "Тип:",
  "Qo'shimcha ish": "Дополнительная работа",
  "Qo'shimcha ishlar": "Дополнительные работы",
  "Ziyoda": "Сверх нормы",
  ...
  "{n} kam": "{n} меньше",
  "{n} ko'p": "{n} больше",
  "Rejaga aniq muvofiq": "Точно по плану",
  "Rejaga muvofiq uyqu": "Сон по плану",
  "✓ belgilandi": "✓ отмечено",
  "✗ belgilandi": "✗ отмечено",
  ...
  "Fokus — ish vaqti": "Фокус — рабочее время",
  "Focus vaqti": "Время фокуса",
  ...
  "Papka o'chirilsinmi?": "Удалить эту папку?",
  ...
  "Qo'shimcha ish o'chirilsinmi?": "Удалить эту дополнительную работу?",
  ...
  "Sikl — kunlik pomodoro maqsadingiz. Yetganingizda hisob yashil rangda ko'rinadi.": "Цикл — ваша дневная цель по помодоро. При её достижении счёт становится зелёным.",
  ...
  "hisoblanadi — qismiy bajarilish beradi, ortiqchasi “ziyoda”ga o'tadi.": "засчитывается — даёт частичное выполнение, а излишек переходит в «сверх нормы».",
  ...
  "Papkani o'chirish uchun avval ichidagi vazifalarni boshqa joyga ko'chiring.": "Чтобы удалить папку, сначала перенесите задачи из неё в другое место.",
  ...
  "Vazifaga tegishli bo'lsa — o'sha vazifaga «ziyoda» qo'shiladi va statistikaga kiradi.": "Если относится к задаче — к ней добавится «сверх нормы» и войдёт в статистику.",
  "Rejadan ortiq ish qilsangiz — Bugun'dagi “Qo'shimcha ish” bo'limiga yozing. Vijdon — eng adolatli guvoh.": "Если сделали больше плана — запишите в раздел «Дополнительная работа» на странице «Сегодня». Совесть — самый справедливый свидетель.",
  ...
  "Kunlik vaqti: {v}. Ortiqcha ajratilgan vaqt belgilashda “ziyoda”ga o'tadi.": "Дневное время: {v}. Излишне выделенное время при отметке уйдёт в «сверх нормы».",
  ...
  "Maqsadni qayta shakllantirasizmi?": "Переформулировать цель?",
  "Maqsadni qayta shakllantirish": "Переформулировать цель",
  "Maqsadni qaytadan tuzish": "Построить цель заново",
  "Maqsadingizga umumiy qancha vaqtda yetishni niyat qilgansiz?": "За какое время вы намерены достичь своей цели?",
  "Qachondan harakatga kirmoqchisiz?": "Когда хотите начать?",
  ...
  "Yil davomida nimani nechta qilishni belgilang — masalan «yiliga 10 kitob», «100 dars». Bu raqamlar Maqsad bo'limidagi progressni yuritadi.": "Задайте, сколько и чего сделаете за год — например «10 книг в год», «100 уроков». Эти числа ведут прогресс в разделе «Цель».",
  ...
  "Kunlik ulush qanday o'lchanadi?": "Как измеряется дневная доля?",
  "Kunlik ulushni kiriting.": "Введите дневную долю.",
  "Muhimlik darajasi (1-10)": "Уровень важности (1-10)",
  "Yiliga nechta? (masalan 10)": "Сколько в год? (например 10)",
  "Shu tempda yil oxirida taxminan": "При таком темпе к концу года будет примерно",
  ...
  // --- Kun, hafta, dam ---
  "Bugun dam kuni — halovat oling": "Сегодня день отдыха — отдохните",
  "Dam kuni foizga kirmaydi — halovat kuni.": "День отдыха не входит в процент — это день покоя.",
  ...
  "Har kuni shu yerdan boshlaysiz. Vazifa katakchasini bosganingizda belgilash oynasi ochiladi. Rejadan ortiq ish qilsangiz «Qo'shimcha ish» bo'limiga yozasiz — u tegishli vazifaga ziyoda bo'lib qo'shiladi.": "Каждый день вы начинаете отсюда. При нажатии на квадрат задачи открывается окно отметки. Если сделали больше плана — запишите в «Дополнительную работу», и это добавится к нужной задаче как «сверх нормы».",
  ...
  "Masalan: mutolaa, sport...": "Например: чтение, спорт...",
