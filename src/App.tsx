...
// LUG'AT: kalit = o'zbekcha lotin matnning O'ZI. Tarjima topilmasa o'zbekchasi ko'rinadi (hech qachon bo'sh qolmaydi).
const LUGAT: Record<string, Partial<Record<Lang, string>>> = {};
// Kirillga avtomatik o'girish xato chiqqan matnlar shu yerga yoziladi (istisno)
const KIRIL_ISTISNO: Record<string, string> = {};
...
function tf(s: string, vals: Record<string, string | number>): string {
  let r = tr(s);
...
export default function App() {
  ...
  CUR = lang; // til almashsa butun ekran shu qiymat bilan qayta chiziladi
